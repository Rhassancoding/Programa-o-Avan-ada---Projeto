...
public class Level extends Perguntas {
     ...
     void PerguntasfacilTI(){ Scanner opcao = new Scanner(System.in);
      int Points=0;String res;
              System.out.println("\n----Theme is Games ---\n Mod:Easy\n 1.Qual destes passwords foi o mais usado na internet?\n"+"\n"+"a)a1b2c3\n" +"b)adcdef\n" +"c)123456 ");       
               ...
               System.out.println("\n2.O que significa a sigla “www” na internet\n" +"\n"+"a)World wide web\n" +"b)Web World wide\n" +"c)Web wide World" );
                 res = opcao.next(); if(res == "a"){Points=Points+1; 
            ...
            System.out.println("\n5.Quantos bits cabem em um byte? \n" +"\n"+"a)8 bits\n"+"b)1 bit\n" +"c)12 bits");
                   res = opcao.next(); if(res.equals("a")){Points=Points+1; System.out.println("\t---Mod Easy finish---\n");PerguntasmedTI();} PerguntasmedTI();
     ...
     void PerguntasfacilGames(){ 
       ...
       int Points=0;String res;
            ...
            System.out.println("\n5-Qual foi o console mais vendido do mundo?\n" +"a)PS2\n"+"b)Wii\n" +"c)Atari\n" +"d)Xbox 360");
                   res = opcao.next(); if(res.equals("a")){Points=Points+1; System.out.println("---Mod Easy finish------ ");PerguntasmedGames();}PerguntasmedGames();
     }}}
       ...
       int Points=0;String res;
              System.out.println("\n----Theme is Games ---\n Mod:Easy\n 1.Qual esporte praticado em Hogwarts?\n" +"a)Basquete\n"+"b)Futebol\n"+"c)Quadribol");       
               ...
               System.out.println("\n2.Qual personagem do seriado CHAVES mora numa casa de número 71?\n" +"a)Seu Madruga\n" +"b)Dona Clotilde\n" +"c)Chaves" );
                 res = opcao.next(); if(res == "b"){Points=Points+1;
           ...
           System.out.println("\n5.Qual o nome da espada lendária do Rei Artur?\n" +"a)Excalibur\n"+"b)Sabre de Luz\n"+"c)Espada de Gryffindor");
                   res = opcao.next(); if(res.equals("a")){Points=Points+1; System.out.println("---Mod Easy finish---");PerguntasfacilFilmes();} PerguntasfacilFilmes();
     ...
     Scanner opcao = new Scanner(System.in);
      int Points=0;String res;
          ...
          System.out.println("\n5-Quanto às memórias, podemos afirmar que existe uma memória somente de leitura onde seus dados não são perdidos quando desligada. Estamos falando da memória:\n" +"a)DDR\n"+"b)DDR2\n"+"c)ROM\n"+"d)DDR3");
                   res = opcao.next(); if(res.equals("c")){Points=Points+1; System.out.println("---Mod Medio finish---");PerguntashardTI();} PerguntashardTI();
     ...
     void PerguntasmedGames(){Scanner opcao = new Scanner(System.in);
      int Points=0;String res;
          ...
          System.out.println("\n5-Qual foi o FIFA lançado para o Wii U?\n"+"a)FIFA12\n" +"b)FIFA13\n" +"c)FIFA14");
                   res = opcao.next(); if(res.equals("b")){Points=Points+1; System.out.println("---Mod Medio finish---");PerguntashardGames();} PerguntashardGames();
              
            }}}
     
     void PerfuntasmedFilmes(){
          Scanner opcao = new Scanner(System.in);
       int Points=0;String res;
            ...
            System.out.println("\n5.Como Thanos consegue a Joia da alma em ‘Infinity War’?\n" +"a)Sacrificando Gamora em Vormir\n" +"b)Travando uma guerra em Asgard\n" +"c)Comprou na 25 de março ");
                   res = opcao.next(); if(res.equals("a")){Points=Points+1;  System.out.println("---Mod Medio finish--- ");PerfuntasmedFilmes();} PerfuntasmedFilmes();
     ...
     //////////////////////////////////////////////Modo Dificil/////////////////////////////////////////////////////////////
      ...
      int Points=0;String res;
          ...
          System.out.println("\n5-São tipos de memória utilizadas nos computadores e classificadas como não-voláteis:\n" +"FPM, DDR3, Ea)EPROM e EDO.\n" +"FPM, Flash, b)EEPROM e DRAM.\n"+"DDR3, EPROM, c)SRAM e Flash.\n"+"ROM, EEPROM, d)Flash e PROM.");
                   res = opcao.next(); if(res.equals("d")){Points=Points+1; System.out.println("---Mod Hard finish--- Points: "+ Points);} 
      ...
      int Points=0;String res;
              System.out.println("\n----Theme is Games ---\n Mod:Hard\n 1-O logo do Dreamcast era vermelho porém na Europa não. De que cor era na Europa?\n"+"a)Azul\n"+"b)Verde\n" +"c)Laranja\n"+"d)Roxo");       
               ...
               System.out.println("\n2-Qual é a última palavra dita em COD Ghosts?\n" +"a)\"Não\"\n" +"b)\"Obrigado\"\n"+"c)\"Ghost\"\n"+"d)\"Logan\"" );
                 res = opcao.next(); if(res == "d"){Points=Points+1; 
         ...
         System.out.println("\n5-Qual o nome do monstro que engole os policiais locais que estavam com Leon no começo do jogo?\n" +"a)Del Lago\n"+"b)Del Rio\n" +"c)El Lago\n" +"d)The Monster");
                   res = opcao.next(); if(res.equals("b")){Points=Points+1; System.out.println("---Total Points: "+ Points);} 
       ...
       int Points=0;String res;
          ...
          System.out.println("\n4.Em que dia foi lançado “Star Wars: The Empire Strikes Back?\n" +"a)4 de julho de 1888\n" +"b)21 de junho de 1980\n" +"c)15 de novembro de 1985");
            ...
            if(Points ==4 ){System.out.println("\n5.Por quem foi dirigido A obra ‘O Poderoso Chefão’?\n" +"a)Francis Ford Coppola\n" +"b)Steven Spielberg\n" +"c)Quentin Tarantino  ");
                   res = opcao.next(); if(res.equals("a")){Points=Points+1; System.out.println("---Mod Hard finish--- Points: "+ Points);}}
